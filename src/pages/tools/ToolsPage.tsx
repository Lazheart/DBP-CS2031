      ...
      <div className="tools-page-content">
        ...
        <div className="tools-intro-container">
          ...
          <p className="tools-intro-desc">
            Desarrollar software va más allá de construir APIs e interfaces de
            usuario. Existen diversas herramientas fundamentales que permiten
            optimizar el desarrollo, automatizar tareas y colaborar de manera
            más eficiente. Dominarlas no solo potenciará tu productividad, sino
            que es indispensable para desenvolverte como desarrollador
            profesional.
          </p>
          ...
          <div className="tools-section-header">
            ...
            <p className="tools-section-subtitle">
              En este módulo revisaremos detalladamente las siguientes
              herramientas:
            </p>
          </div>
        </div>

        <div className="tool-grid hero-section-minibg">
          <Link to="/tools/git" className="tool-card">
            ...
            <p className="tool-card__desc">
              Herramienta de control de versiones, asegúrate siempre de poder
              volver a una versión correcta.
            </p>
          </Link>
          ...
          <Link to="/tools/docker" className="tool-card">
            ...
            <p className="tool-card__desc">
              Plataforma que permite crear y distribuir aplicaciones en
              contenedores. Evita el "funcionaba en mi máquina".
            </p>
          </Link>
          ...
          <Link to="/tools/postman" className="tool-card">
            ...
            <p className="tool-card__desc">
              Herramienta de pruebas de APIs y peticiones HTTP. Automatiza
              pruebas a APIs y muchísimo más.
            </p>
          </Link>
          ...
          <Link to="/tools/github" className="tool-card">
            ...
            <p className="tool-card__desc">
              Plataforma web colaborativa basada en Git. Ejecuta flujos de
              trabajo complejos con GitHub Actions.
            </p>
          </Link>
        </div>
